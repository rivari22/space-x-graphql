...
export type DeleteUserMutation = { __typename?: 'Mutation', delete_users?: { __typename?: 'users_mutation_response', affected_rows: number, returning: Array<{ __typename?: 'users', name?: string | null, id: any, rocket?: string | null }> } | null };
...
export type InsertUserMutationMutation = { __typename?: 'Mutation', insert_users?: { __typename?: 'users_mutation_response', affected_rows: number, returning: Array<{ __typename?: 'users', id: any, name?: string | null, rocket?: string | null }> } | null };

export type GetUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'users', id: any, name?: string | null, rocket?: string | null, twitter?: string | null }> };
...
export type GetLaunchesPastQuery = { __typename?: 'Query', launchesPast?: Array<{ __typename?: 'Launch', mission_name?: string | null, id?: string | null, launch_site?: { __typename?: 'LaunchSite', site_name_long?: string | null } | null, links?: { __typename?: 'LaunchLinks', article_link?: string | null, video_link?: string | null, wikipedia?: string | null } | null } | null> | null };
...
export const InsertUserMutationDocument = gql`
    mutation InsertUserMutation($id: uuid, $name: String, $rocket: String, $timestamp: timestamptz, $twitter: String) {
  insert_users(
    objects: {id: $id, name: $name, rocket: $rocket, timestamp: $timestamp, twitter: $twitter}
  ) {
    affected_rows
    returning {
      id
    ...
    `;
export type InsertUserMutationMutationFn = Apollo.MutationFunction<InsertUserMutationMutation, InsertUserMutationMutationVariables>;
 ...
 *      id: // value for 'id'
 *      name: // value for 'name'
 *      rocket: // value for 'rocket'
 *      timestamp: // value for 'timestamp'
 *      twitter: // value for 'twitter'
 *   },
 * });
 */
export function useInsertUserMutationMutation(baseOptions?: Apollo.MutationHookOptions<InsertUserMutationMutation, InsertUserMutationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<InsertUserMutationMutation, InsertUserMutationMutationVariables>(InsertUserMutationDocument, options);
      }
export type InsertUserMutationMutationHookResult = ReturnType<typeof useInsertUserMutationMutation>;
export type InsertUserMutationMutationResult = Apollo.MutationResult<InsertUserMutationMutation>;
export type InsertUserMutationMutationOptions = Apollo.BaseMutationOptions<InsertUserMutationMutation, InsertUserMutationMutationVariables>;
export const GetUsersDocument = gql`
    query GetUsers {
  users(where: {name: {_eq: "rivari-tech-sharing"}}) {
    id
    name
    rocket
    twitter
...
export const GetLaunchesPastDocument = gql`
...
/**
 * __useGetLaunchesPastQuery__
 *
 * To run a query within a React component, call `useGetLaunchesPastQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLaunchesPastQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLaunchesPastQuery({
 *   variables: {
 ...
 * });
 */
export function useGetLaunchesPastQuery(baseOptions?: Apollo.QueryHookOptions<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>(GetLaunchesPastDocument, options);
      }
export function useGetLaunchesPastLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>(GetLaunchesPastDocument, options);
        }
export type GetLaunchesPastQueryHookResult = ReturnType<typeof useGetLaunchesPastQuery>;
export type GetLaunchesPastLazyQueryHookResult = ReturnType<typeof useGetLaunchesPastLazyQuery>;
export type GetLaunchesPastQueryResult = Apollo.QueryResult<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>;